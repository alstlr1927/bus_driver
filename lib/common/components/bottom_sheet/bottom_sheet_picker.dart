...
import 'theme/bottom_sheet_theme.dart';
    ...
    return Material(
      ...
      child: Padding(
        padding: EdgeInsets.only(
            left: 16, right: 16, bottom: GonStyle.defaultBottomPadding()),
        child: Listener(
            ...
            children: [
              Container(
                decoration: BoxDecoration(
                  ...
                  boxShadow: GonStyle.elevation_8dp(),
                ),
                child: ClipRRect(
          ...
          Expanded(
            child: Container(
              ...
              child: Text('${widget.cancelItem!.title}',
                  textAlign: TextAlign.center,
                  style: GonStyle.body2(
                      color: GonStyle.gray070, weight: FontWeight.w600)),
            )),
          ),
        ],
      ),
